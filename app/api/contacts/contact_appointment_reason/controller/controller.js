...
// create main model 
const DataTable = db.contact_appointment_reasons
...
const store = async (req, res) => {
    ...
    let info = {
        contact_reason_id: req.body.contact_reason_id,
        contact_appointment_id: req.body.contact_appointment_id
    }
...
const PaginateData = async (req, res) => {
    ...
    let query = {
        ...
        include: [
            {
                model: Contact_appointment_dataTable
            },
            {
    ...
    if (searchKey) {
        query.where = {
            [Op.or]: [
                { contact_reason_id: { [Op.like]: `%${searchKey}%` } },
                { contact_appointment_id: { [Op.like]: `%${searchKey}%` } },
            ]
        };
    }
